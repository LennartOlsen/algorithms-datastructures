...
public class BinarySearchTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    public int countFullNodes() throws UnderflowException{
        if(isEmpty())
            throw new UnderflowException();

        return countFullNodes( root, 0 );
    }

    public int countLeaves() throws UnderflowException {
        if(isEmpty())
            throw new UnderflowException();
    ...
    private int countNodes(BinaryNode<AnyType> t, int c) {
        //Test dead end
        if (t == null) return c;
    ...
    private int countFullNodes(BinaryNode<AnyType> t, int c) {
        //Test dead end
        if (t == null) return c;
        ...
        c = countFullNodes(t.left, c);
        c = countFullNodes(t.right, c);
        return c;
    }

    private int countLeaves(BinaryNode<AnyType> t, int c) {
        //Test dead end
        if (t == null) return c;
